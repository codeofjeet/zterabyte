...
const points = [
  "Build a stronger Facebook presence",
  "Create engaging content",
  "Reach relevant audiences",
  "Turn engagement into business opportunities",
];

export default function FacebookMarketingCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's build a Facebook marketing strategy that connects your
                brand with the right audience and creates meaningful
                engagement.
              </p>
