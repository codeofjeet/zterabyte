        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              Build a stronger online presence with strategic SEO, social
              media and digital marketing campaigns designed to reach the
              right audience and support business growth.
            </p>
              ...
              <div className="relative rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur sm:p-7">
                ...
                <div className="mt-7 rounded-2xl bg-white p-5">
                  ...
                  <div className="mt-7 flex h-32 items-end gap-2">
                    ...
                    <div className="h-[35%] flex-1 rounded-t-lg bg-[#dbeeff]" />
                    <div className="h-[48%] flex-1 rounded-t-lg bg-[#b9ddf4]" />
                    <div className="h-[42%] flex-1 rounded-t-lg bg-[#b9ddf4]" />
                    <div className="h-[62%] flex-1 rounded-t-lg bg-[#8bc9ef]" />
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    ...
                    <FiTarget className="text-[#38a9f5]" />
