        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              Put your business in front of people actively searching for
              your products and services with focused Google Ads campaigns
              ...
              <div className="relative rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur sm:p-7">
                ...
                <div className="mt-7 rounded-2xl bg-white p-5">
                  ...
                  <div className="mt-6 flex h-20 items-end gap-2">
                    <div className="h-[25%] flex-1 rounded-t-lg bg-[#dbeeff]" />
                    <div className="h-[35%] flex-1 rounded-t-lg bg-[#b9ddf4]" />
                    <div className="h-[46%] flex-1 rounded-t-lg bg-[#b9ddf4]" />
                    <div className="h-[58%] flex-1 rounded-t-lg bg-[#8bc9ef]" />
                    <div className="h-[69%] flex-1 rounded-t-lg bg-[#38a9f5]" />
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center">
                    <FiMousePointer className="mx-auto text-lg text-[#38a9f5]" />
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center">
                    <FiTarget className="mx-auto text-lg text-[#38a9f5]" />
