...
const points = [
  ...
  "Build a stronger organic store presence",
];

export default function EcommerceSEOCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's optimize your online store and make your products easier
                to discover through organic search.
              </p>
            ...
            <div className="lg:min-w-[230px]">
              ...
              <p className="mt-4 text-center text-xs text-slate-500">
                Tell us about your store and SEO goals.
              </p>
