...
export default function SEOAndSMOCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <h2 className="mt-6 max-w-3xl text-3xl font-black leading-tight text-white sm:text-4xl lg:text-5xl">
                ...
                <span className="block text-[#38a9f5]">
                  Search & Social Presence?
                </span>
              </h2>

              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's build an SEO and SMO strategy that helps your business
                become more visible, reach relevant audiences and strengthen
            ...
            <div className="lg:min-w-[230px]">
              ...
              <p className="mt-4 text-center text-xs text-slate-500">
                Tell us about your business and online growth goals.
              </p>
