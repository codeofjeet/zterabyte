...
const points = [
  "Build a stronger Twitter presence",
  "Create relevant and engaging content",
  "Connect with the right audience",
  "Turn conversations into business opportunities",
];

export default function TwitterMarketingCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's create a Twitter marketing strategy that helps your
                business join relevant conversations, connect with your
