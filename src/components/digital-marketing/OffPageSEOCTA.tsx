...
const points = [
  ...
  "Develop a stronger SEO foundation",
];

export default function OffPageSEOCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's develop an off-page SEO strategy focused on relevant
                connections, stronger authority and sustainable search
                visibility.
              </p>
            ...
            <div className="lg:min-w-[230px]">
              ...
              <p className="mt-4 text-center text-xs text-slate-500">
                Tell us about your website and SEO goals.
              </p>
