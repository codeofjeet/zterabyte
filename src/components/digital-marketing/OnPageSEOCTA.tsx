...
const points = [
  ...
  "Improve content and page structure",
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's improve the important pages of your website and build a
                stronger on-page SEO foundation for long-term digital growth.
              </p>
