...
const points = [
  ...
  "Turn email communication into business opportunities",
];
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's create an email marketing strategy that keeps your brand
                connected with the right audience and supports your business
                goals.
              </p>
