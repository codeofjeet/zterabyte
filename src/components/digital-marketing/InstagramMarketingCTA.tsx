...
const points = [
  "Build a stronger Instagram presence",
  "Create engaging visual content",
  "Connect with relevant audiences",
  "Turn engagement into business opportunities",
];

export default function InstagramMarketingCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's create an Instagram marketing strategy that helps your
                brand attract attention, engage the right audience and build
                lasting connections.
              </p>
            ...
            <div className="lg:min-w-[230px]">
              ...
              <p className="mt-4 text-center text-xs text-slate-500">
                Tell us about your business and social media goals.
              </p>
