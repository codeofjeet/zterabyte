...
const steps = [
  {
    ...
    description:
      "We understand your business goals, target users, app requirements and important functionality before development begins.",
    points: [
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "We create clear mobile interfaces and user flows focused on usability, navigation and your brand.",
    points: [
      "Screen layouts",
      "User experience",
  ...
  },
  {
    ...
    description:
      "We develop the application, connect required APIs and implement the functionality planned for your project.",
    points: [
  ...
  },
  {
    ...
    description:
      "We test important application functionality and prepare the app for deployment and release.",
    points: [
      "Device testing",
      "Bug fixing",
      "Launch preparation",
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
            A clear development process helps turn your application idea
            into a structured and reliable mobile product.
          </p>
        ...
        {/* Bottom Highlight */}
        <div className="mt-10 rounded-2xl border border-[#dbeeff] bg-[#f6fafd] p-6 sm:p-7">
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-[#071827]">
                A mobile app built around your users
              </h3>

              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                From planning and UI/UX to development, testing and launch,
                every stage is focused on creating a useful mobile experience.
              </p>
