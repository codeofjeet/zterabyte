...
const steps = [
  {
    ...
    description:
      "We learn about your business, target audience, industry and the personality you want your brand to communicate.",
    points: [
  ...
  },
  {
    ...
    description:
      "We explore creative directions and develop logo concepts based on the agreed brand requirements.",
    points: [
      "Creative concepts",
  ...
  },
  {
    ...
    title: "Review & Refine",
    description:
      "Review the selected concept and refine the visual details to create a polished final identity.",
    points: [
      "Concept review",
      "Design refinement",
      "Visual adjustments",
  ...
  },
  {
    ...
    description:
      "Prepare the approved logo in suitable formats for your website, social media, marketing and other uses.",
    points: [
      "Final logo files",
      "Multiple formats",
...
export default function LogoDesignProcess() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
            A structured design process helps turn your brand ideas into a
            clear and professional visual identity.
          </p>
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-[#071827]">
                A logo designed around your business
              </h3>

              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                From the initial idea to the final files, every stage focuses
                on creating a practical and recognizable brand identity.
              </p>
