...
const points = [
  ...
  "Social media and promotional designs",
  "Professional business materials",
  "Consistent visual branding",
];

export default function GraphicsDesignCTA() {
  return (
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Let's create professional graphics that communicate your
                message, support your marketing and strengthen your brand
                presence.
              </p>
            ...
            <div className="lg:min-w-[230px]">
              ...
              <p className="mt-4 text-center text-xs text-slate-500">
                Tell us about your business and design requirements.
              </p>
